 ...
 *  MmZy的处理
 * */
public class MmZyDataSourceHandle implements IDataSourceStrategy {


    private final String KEY = "MmZy";
    ...
    public static void main(String[] args) {
        MmZyDataSourceHandle handle = new MmZyDataSourceHandle();
       /* handle.search("海上", 1);
        VideoSearch videoSearch = new VideoSearch();*/
