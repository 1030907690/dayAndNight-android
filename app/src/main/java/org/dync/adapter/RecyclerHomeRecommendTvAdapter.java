...
public class RecyclerHomeRecommendTvAdapter extends RecyclerView.Adapter<RecyclerHomeRecommendTvAdapter.MyViewHolder> {
    ...
    public RecyclerHomeRecommendTvAdapter(Context context, List<VideoSearch> mDatas) {
