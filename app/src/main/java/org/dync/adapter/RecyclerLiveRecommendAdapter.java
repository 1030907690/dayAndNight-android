...
public class RecyclerLiveRecommendAdapter extends RecyclerView.Adapter<RecyclerLiveRecommendAdapter.MyViewHolder> {
    ...
    public RecyclerLiveRecommendAdapter(Context context, List<Live> mDatas) {
