...
public class WatchHistoryRecyclerViewAdapter extends RecyclerView.Adapter<WatchHistoryRecyclerViewAdapter.ViewHolder> {
    ...
    public WatchHistoryRecyclerViewAdapter(Context context, List<MovieDataModel> mList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.watch_history_activity_item, parent, false);
