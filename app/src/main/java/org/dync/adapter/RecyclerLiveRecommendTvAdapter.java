...
public class RecyclerLiveRecommendTvAdapter extends RecyclerView.Adapter<RecyclerLiveRecommendTvAdapter.MyViewHolder> {

    private Context context;
    private List<Live> mDatas;
    /**
     * 事件
     **/
    ...
    public RecyclerLiveRecommendTvAdapter(Context context, List<Live> mDatas) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder holder = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.home_recommend_item_tv, parent, false));
        return holder;
    }
