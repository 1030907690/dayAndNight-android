...
public class SampleMediaListFragment extends Fragment {
    ...
    @SuppressLint("ValidFragment")
    public SampleMediaListFragment(List<Video> video) {
        this.video = video;
    }

    public SampleMediaListFragment() {
   ...
   /* public static SampleMediaListFragment newInstance() {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        for (Video vo : video) {
            mAdapter.addItem(vo.getUrl(), vo.getName());
        }
        /*
        mAdapter.addItem("https://pp.www605zy.com/20190818/WQAj5Mgk/800kb/hls/ILytzad3383000.ts", "抓包冰封恋爱ts");
        mAdapter.addItem("https://pp.www605zy.com/ppvod/2DCDFAD0266B7885A07ABF7E8F3F9ACC.m3u8", "抓包冰封恋爱605yun");
        mAdapter.addItem("https://pp.www605zy.com/share/rCrPBlpmLbWBLzQL", "冰封恋爱605yun");
        mAdapter.addItem("https://pp.www605zy.com/20190818/WQAj5Mgk/index.m3u8", "冰封恋爱m3u8");
        mAdapter.addItem("https://youku.rebo5566.com/20190808/QCgZI4gD/index.m3u8", "m3u8");
